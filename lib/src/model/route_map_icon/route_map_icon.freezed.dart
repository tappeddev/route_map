...
mixin _$RouteMapIcon {
 ...
 Path get markerPath; LatLng get latLng; String get identifier; RouteMapIconTheme get theme; RouteMapIconTheme? get darkTheme; String? get svgIconPath; String? get text; String? get label; double? get rotationDegrees; bool get draggable; RouteMapIconAnchor get anchor;
...
@override
int get hashCode => Object.hash(runtimeType,markerPath,latLng,identifier,theme,darkTheme,svgIconPath,text,label,rotationDegrees,draggable,anchor);

@override
String toString() {
  return 'RouteMapIcon(markerPath: $markerPath, latLng: $latLng, identifier: $identifier, theme: $theme, darkTheme: $darkTheme, svgIconPath: $svgIconPath, text: $text, label: $label, rotationDegrees: $rotationDegrees, draggable: $draggable, anchor: $anchor)';
}
...
@useResult
$Res call({
 Path markerPath, LatLng latLng, String identifier, RouteMapIconTheme theme, RouteMapIconTheme? darkTheme, String? svgIconPath, String? text, String? label, double? rotationDegrees, bool draggable, RouteMapIconAnchor anchor
});
...
/// Create a copy of RouteMapIcon
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? markerPath = null,Object? latLng = null,Object? identifier = null,Object? theme = null,Object? darkTheme = freezed,Object? svgIconPath = freezed,Object? text = freezed,Object? label = freezed,Object? rotationDegrees = freezed,Object? draggable = null,Object? anchor = null,}) {
  return _then(_self.copyWith(
markerPath: null == markerPath ? _self.markerPath : markerPath // ignore: cast_nullable_to_non_nullable
as Path,latLng: null == latLng ? _self.latLng : latLng // ignore: cast_nullable_to_non_nullable
...
as String?,rotationDegrees: freezed == rotationDegrees ? _self.rotationDegrees : rotationDegrees // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Path markerPath,  LatLng latLng,  String identifier,  RouteMapIconTheme theme,  RouteMapIconTheme? darkTheme,  String? svgIconPath,  String? text,  String? label,  double? rotationDegrees,  bool draggable,  RouteMapIconAnchor anchor)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RouteMapIcon() when $default != null:
return $default(_that.markerPath,_that.latLng,_that.identifier,_that.theme,_that.darkTheme,_that.svgIconPath,_that.text,_that.label,_that.rotationDegrees,_that.draggable,_that.anchor);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Path markerPath,  LatLng latLng,  String identifier,  RouteMapIconTheme theme,  RouteMapIconTheme? darkTheme,  String? svgIconPath,  String? text,  String? label,  double? rotationDegrees,  bool draggable,  RouteMapIconAnchor anchor)  $default,) {final _that = this;
switch (_that) {
case _RouteMapIcon():
return $default(_that.markerPath,_that.latLng,_that.identifier,_that.theme,_that.darkTheme,_that.svgIconPath,_that.text,_that.label,_that.rotationDegrees,_that.draggable,_that.anchor);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Path markerPath,  LatLng latLng,  String identifier,  RouteMapIconTheme theme,  RouteMapIconTheme? darkTheme,  String? svgIconPath,  String? text,  String? label,  double? rotationDegrees,  bool draggable,  RouteMapIconAnchor anchor)?  $default,) {final _that = this;
switch (_that) {
case _RouteMapIcon() when $default != null:
return $default(_that.markerPath,_that.latLng,_that.identifier,_that.theme,_that.darkTheme,_that.svgIconPath,_that.text,_that.label,_that.rotationDegrees,_that.draggable,_that.anchor);case _:
  return null;
...
@override final  double? rotationDegrees;
...
/// Create a copy of RouteMapIcon
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? markerPath = null,Object? latLng = null,Object? identifier = null,Object? theme = null,Object? darkTheme = freezed,Object? svgIconPath = freezed,Object? text = freezed,Object? label = freezed,Object? rotationDegrees = freezed,Object? draggable = null,Object? anchor = null,}) {
